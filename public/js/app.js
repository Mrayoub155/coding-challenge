          ...
          _c("div", { staticClass: "sortList" }, [
            ...
            _c("div", { staticClass: "form-check" }, [
              _c("input", {
                ...
                domProps: {
                  checked: Array.isArray(_vm.sortByName)
                    ? _vm._i(_vm.sortByName, null) > -1
                    : _vm.sortByName
                },
                on: {
            ...
            _c("div", { staticClass: "form-check" }, [
              _c("input", {
                ...
                domProps: {
                  checked: Array.isArray(_vm.sortByPrice)
                    ? _vm._i(_vm.sortByPrice, null) > -1
                    : _vm.sortByPrice
                },
                on: {
                  select: function($event) {
                  ...
                  change: function($event) {
                    ...
                    if (Array.isArray($$a)) {
                      var $$v = null,
                        $$i = _vm._i($$a, $$v)
                      if ($$el.checked) {
                        $$i < 0 && (_vm.sortByPrice = $$a.concat([$$v]))
                      } else {
                        $$i > -1 &&
                          (_vm.sortByPrice = $$a
                            .slice(0, $$i)
